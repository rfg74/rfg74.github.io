...
I found my PID values expereimentally. Based on my findings from lab 5, I began tweaking my values until I found what worked best for my robot. Starting with a base of Kp = 0.1, Ki = 0.001, and Kd = 0.05, I took turns tweaking each constant until the values were optimized for my system. After a long period of trial and error, I found that the optimal set of parameters was Kp = 0.06, Ki = 0.01, and Kd = 0.08. Similarly to my code from lab 5, I implemented an upper and lower bound to ensure that my PID control is always within a proper range such that it won't be higher than 255 and will always have enough outptut to actually overcome static friction. I collected the relevant data in arrays which could then be easily parsed through to analyze performance.

## References

For this lab I referenced the DMP guide on the course website, and the websites of Stephen Wagner and Mikayla Lahr, and Nidhi Sonwalkar. I also used chatGPT to help clean up my code and 
